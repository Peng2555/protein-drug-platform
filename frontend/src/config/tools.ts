...
export const PLATFORM_TOOLS: PlatformTool[] = [
  ...
  },
  {
    ...
    route: '/hydro-redesign/new',
    function: 'developability',
    modalities: ['antibody'],
    inputs: ['fasta', 'pdb'],
    description: '无抗原：表面疏水斑识别与亲水突变枚举，不重折突变体。',
    duration: '十余分钟–数小时',
    isNew: true,
    engines: ['Boltz2'],
  },
  {
    ...
    route: '/cic-profile/new',
    function: 'developability',
    modalities: ['antibody'],
    inputs: ['fasta', 'pdb'],
    description: '实验 pH 下识别表面正电、负电与疏水斑，3D 着色展示。第一版无 APBS。',
    duration: '十余分钟–数小时',
    isNew: true,
    engines: ['Boltz2'],
  },
  {
    ...
    route: '/tnp-profile/new',
    function: 'developability',
    modalities: ['antibody'],
    inputs: ['fasta', 'pdb'],
    description: 'Boltz2 + Kabat：六项可开发性指标与 tetrad，支持单条与批量。',
    duration: '十余分钟–数小时',
    isNew: true,
    engines: ['Boltz2'],
  },
